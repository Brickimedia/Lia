 ...
 * @ingroup Skins
 */
class SkinLiaMobile extends SkinTemplate {

	protected static $bodyClasses = array( 'vector-animateLayout' );

	var $skinname = 'liamobile', $stylename = 'liamobile',
		$template = 'LiaMobileTemplate', $useHeadElement = true;
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addStyle('liamobile/screen.css', 'screen');
	}
 ...
 * @ingroup Skins
 */
class LiaMobileTemplate extends BaseTemplate {
...
?>
		...
		<!-- content -->
		<div id="content" class="mw-body <?php if ( count( $this->data['view_urls'] ) == 0 ) echo 'curve-right'; ?>">
			<a id="top"></a>
		...
		<!-- panel -->
			...
			<div id="left-right-nav">
				...
				<div id="right-navigation" class="<?php if ( count( $this->data['view_urls'] ) == 0 ) echo ' emptyPortlet'; ?>">
					<?php $this->renderNavigation( array( 'VIEWS' ) ); ?>
				<div id="right-drop">
					<span class="nav-drop">&#9660 </span>
					<ul class="menu">
